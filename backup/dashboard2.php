                  ...
                  <div class="row">
                     ...
                     <div class="col-xs-12 col-sm-3">
                        <div class="form-group">
                           ...
                           <textarea style="" name="note" class="form-control required" placeholder="Add Note" id="Note"  data-error="Please enter note"></textarea>
                        </div>
                     </div>
                     <div class="col-xs-12 col-sm-3">
                        <div class="form-group">
...
/*======================================= Fetch Data ========================================== */
      ...
      //                            console.log('data ss2',data1, data2)
          ...
          $.ajax({
            ...
            success: function(data1){
               ...
               $.ajax({
                  url: "table2.php",
                  type: "POST",
                  data: JSON.stringify(data1['message']),
                  // data:  JSON.stringify(data1),
                  dataType : 'json',
                  cache: false,
                  success: function(data2){
