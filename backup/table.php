      ...
      // if(!empty($_REQUEST['data']['message'])) { 
        ...
        <tr>
          ...
          <td><button type="button" value="<?= $value['id'] ?>" class="sting_icon_btn setting" data-bs-toggle="modal"
                ...
                <!-- <button type="button" id="btn_report" value="<?= $value['id'] ?>" class="view_icon_btn setting" data-bs-toggle="modal" data-bs-target="#clickexampleModal">
                  <span class="sting_icon"><img src="assets/images/view.png" alt=""></span>
                </button> -->
            </td>
          </tr>
