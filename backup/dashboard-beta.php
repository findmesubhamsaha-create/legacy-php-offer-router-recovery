...
if(!isset($_SESSION["is_login"])){
   header("Location: http://localhost/nxmedia/portal/404.php");
}
?>
               ...
               <form action="ajax.php" method="post" name="offerForm">
                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="offer" class="form-control required" id="name" placeholder="Enter offer name" data-error="Please enter offer name">
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-xs-12 col-sm-4">
                        <div class="form-group">
                           ...
                           <textarea style="height: 38px; resize: none;" name="note" class="form-control required" id="Note" placeholder="Note" data-error="Please enter note">
                           </textarea>
                        </div>
                     </div>
                     <div class="col-xs-12 col-sm-4">
                     ...
                     <div class="row suburl">
                        ...
                        <div class="col-xs-12 col-sm-3">
                           <div class="form-group">
                              ...
                              <input type="number" name="weight[]" class="form-control required weights" id="weight1" placeholder="Weight" data-error="Please select weight">
                           </div>
                        </div>
                        <div class="col-xs-12 col-sm-3">
                  ...
                  <div class="row mt-3" style="text-align: right;">
                     <div class="col-xs-12 text-right">
                        <button type="button" onclick="return submitForm()" class="btn btn-primary">Save</button>
      ...
      $("body").on("click", ".setting", function () {
         ...
         $.ajax({
            ...
            success: function(data){
               ...
               console.log(arr[0]['sub_url_details'][0]['status']);
               $("#name").val(arr[0]['offer']);
               $("#Note").val(arr[0]['note']);
                  ...
                  if(i==0){
                   ...
                   newSubUrl += `<div class="row suburl addeddom">
                     ...
                     <div class="col-xs-12 col-sm-3">
                        <div class="form-group">
                           <label for="weight">Weight</label>
                           <input type="number" name="weight[]" class="form-control required weights" value="${arr[0]['sub_url_details'][i]['weight']}" id="weight${i+1}" placeholder="Weight${i+1}" data-error="Please select weight">
                        </div>
                     </div>
                     <div class="col-xs-12 col-sm-3">
                        <div class="form-group checkbox_ottr">
