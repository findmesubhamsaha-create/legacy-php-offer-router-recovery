...
if(!isset($_SESSION["is_login"])){
   header("Location: http://efbhalvbhdsurl.com/portal/404.php");
}
?>
                  ...
                  <div class="row">
                     ...
                     <div class="col-xs-12 col-sm-4">
                        <div class="form-group">
                           ...
                           <textarea style="" name="note" class="form-control required" id="Note" placeholder="Note" data-error="Please enter note">
                           </textarea>
                        </div>
                     </div>
                     <div class="col-xs-12 col-sm-4">
...
/*======================================= Add New Data =============================================== */
      ...
      $("body").on("change", "#mainoffer", function () {
