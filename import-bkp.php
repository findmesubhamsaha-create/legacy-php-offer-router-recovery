...
<p id="loading-indicator" style="display:none;">Processing...</p>
    ...
    document.getElementById('download-link').addEventListener('click', function (e) {
        ...
        // Sample CSV content
        const csvContent = 
            "offer name,slug name,tag name,notes,network,start date,end date,url1,weight1,status1\n" +
            "offer1,slug1,tag1,Sample note,Network1,2024-10-14,2024-12-31,https://abc.com,10,yes\n" +
            "offer2,slug2,tag2,Another note,Network2,2024-10-14,2024-12-31,https://xyz.com,90,yes\n";
